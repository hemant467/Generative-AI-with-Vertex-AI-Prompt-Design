{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "PROJECT_ID = \"qwiklabs-gcp-04-54b844aee9a4\"  # @param {type:\"string\"}\n",
    "\n",
    "# Set the project id\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "BUCKET_URI = \"gs://your-bucket-name-qwiklabs-gcp-04-54b844aee9a4-unique\""
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Creating gs://your-bucket-name-qwiklabs-gcp-04-54b844aee9a4-unique/...\n"
     ]
    }
   ],
   "source": [
    "! gsutil mb -l europe-west4 -p qwiklabs-gcp-04-54b844aee9a4 gs://your-bucket-name-qwiklabs-gcp-04-54b844aee9a4-unique"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "aiplatform.init(project=\"qwiklabs-gcp-04-54b844aee9a4\", location=\"europe-west4\", staging_bucket=\"gs://your-bucket-name-qwiklabs-gcp-04-54b844aee9a4-unique\")"
   ]
  },
  {
   "cell_type": "markdown",
